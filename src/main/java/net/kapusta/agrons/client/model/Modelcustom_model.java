package net.kapusta.agrons.client.model;
...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("agrons", "modelcustom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(116, 41).addBox(-6.0F, -11.0F, -10.0F, 11.0F, 2.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(73, 48)
						...
						.addBox(31.0F, -9.0F, 19.0F, 8.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 54).addBox(29.0F, -11.0F, 18.0F, 12.0F,
								11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(12.0F, -23.0F, -6.0F, 5.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 1.3526F, -1.5708F));
		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(28, 13).addBox(14.0F, -21.0F, -1.0F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
