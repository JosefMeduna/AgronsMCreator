...
public class ModExploreScreen extends AbstractContainerScreen<ModExploreMenu> {
	private final static HashMap<String, Object> guistate = ModExploreMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ModExploreScreen(ModExploreMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("agrons:textures/screens/mod_explore.png");
